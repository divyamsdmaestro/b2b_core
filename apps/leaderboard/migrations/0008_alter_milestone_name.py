# Generated by Django 4.2.3 on 2024-03-05 13:41
...
class Migration(migrations.Migration):
    dependencies = [
        ("leaderboard", "0007_badgeactivity_tracker_id"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("yaksha_completion", "Yaksha Completion"),
                    ("yaksha_champion", "Yaksha Champion"),
                    ...
                    ("quick_finisher_assigned_course", "Quick Finisher Assigned Course"),
                    ...
                    ("learning_path_starter", "Learning Path Starter"),
                    ("skill_achiever", "Skill Achiever"),
                    ("proficiency_achiever", "Proficiency Achiever"),
                    ("leaderboard_level_promoted", "Leaderboard Level Promoted"),
                    ("course_certificate_earned", "Course Certificate Earned"),
                    ("expertise_accomplishment", "Expertise Accomplishment"),
                    ("following_expert", "Following Expert"),
                    ("profile_completion", "Profile Completion"),
                    ("replying_comments_as_expert", "Replying Comments As Expert"),
                    ("replying_comments_as_expert_ontime", "Replying Comments As Expert Ontime"),
                    ("forum_creation", "Forum Creation"),
                    ...
                    ("certification_path_assigned", "Certification Path Assigned"),
                    (
                        "quick_finisher_self_enrolled_certification_path",
                        "Quick Finisher Self Enrolled Certification Path",
                    ),
                    ("quick_finisher_assigned_certification_path", "Quick Finisher Assigned Certification Path"),
                    ("certification_path_starter", "Certification Path Starter"),
                    ("certification_path_certificate_earned", "Certification Path Certificate Earned"),
                    ("yaksha_module_completion", "Yaksha Module Completion"),
                    ("mml_progress", "MML Progress"),
                    ("video_module_completion", "Video Module Completion"),
                    ("assignment_module_completion", "Assignment Module Completion"),
                    ("virtutor_session_completion", "Virtutor Session Completion"),
                    ("overtaking_peers", "Overtaking Peers"),
                    ("certification_path_completion", "Certification Path Completion"),
